...
Source0  : https://github.com/rfjakob/earlyoom/archive/v1.6/earlyoom-1.6.tar.gz
...
%prep
%setup -q -n earlyoom-1.6
cd %{_builddir}/earlyoom-1.6
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586806518
...
cp %{_builddir}/earlyoom-1.6/LICENSE %{buildroot}/usr/share/package-licenses/earlyoom/49c65c4ad5a142b45b01486ac9df8f15d9d6d30b
