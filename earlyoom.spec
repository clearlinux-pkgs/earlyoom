...
Source0  : https://github.com/rfjakob/earlyoom/archive/v1.8.2/earlyoom-1.8.2.tar.gz
...
%prep
%setup -q -n earlyoom-1.8.2
cd %{_builddir}/earlyoom-1.8.2
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a earlyoom-1.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715126698
