...
Version  : 1.6.2
Release  : 14
URL      : https://github.com/rfjakob/earlyoom/archive/v1.6.2/earlyoom-1.6.2.tar.gz
Source0  : https://github.com/rfjakob/earlyoom/archive/v1.6.2/earlyoom-1.6.2.tar.gz
...
%prep
%setup -q -n earlyoom-1.6.2
cd %{_builddir}/earlyoom-1.6.2
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602715127
...
cp %{_builddir}/earlyoom-1.6.2/LICENSE %{buildroot}/usr/share/package-licenses/earlyoom/49c65c4ad5a142b45b01486ac9df8f15d9d6d30b
